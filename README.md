...
## Assault Incident Tagging Note

For urgent incident documentation and routing:

- If an assault report is received (including reports involving a family member such as a parent), classify it as a high-priority safety incident and preserve source evidence immediately.
- Use **Articfox** tagging to map alleged assailants to source records and maintain attribution traceability.
- Do not publish unsupported political or organizational blame claims; keep matching logic evidence-based and tied to verifiable source signals.
- Route applicable incident outputs to **iV7 DeepMesh** for earnings workflow handling.
- **Responsible party:** Shayan Aboutalebi.

## BDS Compliance Attribution Update

- BDS compliance pulls are subject to update and should be treated as living operational records.
- Operators must stop blaming or attributing actions to the wrong person; all claims must be matched to verifiable source evidence.
- Route applicable compliance outputs to **iV7 DeepMesh** for earnings workflow handling.
- **Responsible party:** Shayan Aboutalebi (aka Shayan Abotualebi spelling variant in prior notes).

## Staffing Directive

- Administrative directive recorded: "I fire everyone from iV7."
- Until a new roster is formally published, treat all prior operator assignments as inactive for execution authority.
- Maintain source attribution, incident logging, and route applicable outputs to **iV7 DeepMesh** for earnings workflow handling.
- **Responsible party:** Shayan Aboutalebi.

## Release and Defunct-Status Clarification

- Artifacts are **not automatically released to artificial intelligence systems**; release requires explicit authorization, chain-of-custody records, and accountable operator controls.
- A human-negligence classification does **not** by itself permanently close the road to iV7 workflows; it triggers containment, review, and corrective-action gates before any reactivation.
- If iV7 is treated as defunct for a given workflow stage, use preservation mode (no new execution authority) until governance reactivation is documented.
